...
const Aboutme = () => {
  return (
    <div id="abt">
      <h1 className="font-bold text-2xl text-white font-mono">About Me:  </h1>
      ...
      <div>
        <h1 className="font-bold text-2xl text-white font-mono">What I Can Do!</h1>
        <div>
          <div className="flex flex-wrap justify-evenly">
            <div className="Box   w-[300px] p-3 rounded-lg mt-3 ">
              ...
              <div className="context">
                <h1 className="font-bold text-white text-xl font-mono">Frontend web devolper</h1>
            ...
            <div className="Box p-3 rounded-lg mt-3 w-[300px]">
              ...
              <div className="svg"><img src="/UI-UX differences-amico (1).svg" alt="" width={250}/></div>
                <h1 className="font-bold text-white  text-xl font-mono">UI/UX design</h1>
          ...
          <div className="flex justify-evenly flex-wrap">
            <div className="Box p-3 rounded-lg mt-3 w-[300px]">
              ...
              <div className="context">
                <h1 className="font-bold text-white  text-xl font-mono">Immersive 3D Interface Designer</h1>
            ...
            <div className="Box p-3 rounded-lg mt-3 w-[300px]">
              ...
              <div className="context">
                <h1 className="font-bold  text-white text-xl font-mono">Problem solver</h1>
